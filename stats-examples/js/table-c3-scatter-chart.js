var chart = c3.generate({
    ...
    data: {
        ...
        columns: [
            ...
            ['data1x', 120, 93, 163, 239, 152, 229, 134, 23, 134, 99, 64, 153, 199, 158, 247, 60, 201, 132, 243, 34],
            ['data2x', 249, 119, 42, 211, 178, 35, 37, 203, 247, 102, 241, 60, 240, 246, 235, 223, 219, 223, 131, 42]
        ],
        type: 'scatter',
        names: {
            data1: 'Name 1',
